...
console.time('Buscando PEDRO...') // Dispara a contagem de tempo

console.log('Posição de PEDRO:', buscaSequencial(nomes, 'PEDRO'))

console.timeEnd('Buscando PEDRO...')   // Para a contagem de tempo